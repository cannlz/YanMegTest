...
json_data = {
    'selectedAssumedCollectionId': '12101', #ID Категории дубль
    'collectionId': '12101', #ID Категории
    'requestVersion': 10,
    'limit': 44,
    'offset': 0,
    ...
    'selectedFilters': [
        {
            ...
            'type': 0,
            'value': 'UNKNOWN_OFFER_DUE_DATE', #Доставка
        },
        {
            'filterId': '88C83F68482F447C9F4E401955196697',
            'type': 1,
            'value': '1', #Минимальная цена
        },
        {
            'filterId': '88C83F68482F447C9F4E401955196697',
            'type': 2,
            'value': '2222222', #Максимальная цена
        },
    ],
    'auth': {
        'locationId': '63',
